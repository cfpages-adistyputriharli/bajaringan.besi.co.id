...
# Article Guide — bajaringan.besi.co.id
...
- Address the reader warmly as `Sobat Besi.co.id`, `Kawan Besi.co.id`, or `Teman Besi.co.id`. Use the exact opening salutation assigned inside the article file.
