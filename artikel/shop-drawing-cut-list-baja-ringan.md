---
article_id: LGS-10-01
title: "Shop Drawing dan Cut List Baja Ringan: Kontrol Sebelum Produksi"
slug: "shop-drawing-cut-list-baja-ringan"
description: "Define approved inputs, revision, truss IDs, parts, holes, joints, and release"
status: outline
publication_date: "2026-01-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LGS-10
primary_intent: "Control information"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/shop-drawing-cut-list-baja-ringan.html"
...
# Shop Drawing dan Cut List Baja Ringan: Kontrol Sebelum Produksi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Shop Drawing dan Cut List Baja Ringan: Kontrol Sebelum Produksi”
- **Reader and situation:** Designer/fabricator
- **Reader outcome:** Define approved inputs, revision, truss IDs, parts, holes, joints, and release
- **Primary intent:** Control information
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No design output; LGS-05 owns approved basis
- **Final public route:** `/artikel/shop-drawing-cut-list-baja-ringan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Shop Drawing dan Cut List Baja Ringan: Kontrol Sebelum Produksi**.
...
- **Tie back to this article:** Keep the explanation specific to “Shop Drawing dan Cut List Baja Ringan: Kontrol Sebelum Produksi”.
