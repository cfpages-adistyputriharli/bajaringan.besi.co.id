---
article_id: LGS-06-05
title: "Bukaan Tangki, Skylight, dan Akses pada Rangka Atap"
slug: "bukaan-pada-rangka-atap-baja-ringan"
description: "Define opening loads, trimming, clearances, water, access, and change approval"
status: outline
publication_date: "2025-10-25"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LGS-06
primary_intent: "Coordinate openings"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/bukaan-pada-rangka-atap-baja-ringan.html"
...
# Bukaan Tangki, Skylight, dan Akses pada Rangka Atap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Bukaan Tangki, Skylight, dan Akses pada Rangka Atap”
- **Reader and situation:** MEP/architect/structural team
- **Reader outcome:** Define opening loads, trimming, clearances, water, access, and change approval
- **Primary intent:** Coordinate openings
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No field-cutting/detail design; LGS-05-06 owns changes
- **Final public route:** `/artikel/bukaan-pada-rangka-atap-baja-ringan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Bukaan Tangki, Skylight, dan Akses pada Rangka Atap**.
...
- **Tie back to this article:** Keep the explanation specific to “Bukaan Tangki, Skylight, dan Akses pada Rangka Atap”.
