...
description: "Explain temperature effects, restraint, load, protection, and system context"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Apa yang Terjadi pada Baja Tipis saat Terpapar Api?”
- **Reader and situation:** Owner/designer
- **Reader outcome:** Explain temperature effects, restraint, load, protection, and system context
- **Primary intent:** Understand mechanism
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No fire rating; LGS-15-02 owns assembly evidence
- **Final public route:** `/artikel/baja-tipis-dalam-kebakaran.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Apa yang Terjadi pada Baja Tipis saat Terpapar Api?**.
...
- **Tie back to this article:** Keep the explanation specific to “Apa yang Terjadi pada Baja Tipis saat Terpapar Api?”.
