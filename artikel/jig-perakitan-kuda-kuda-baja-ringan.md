---
article_id: LGS-10-04
title: "Jig dan Perakitan Kuda-Kuda: Menjaga Geometri dan Identitas"
slug: "jig-perakitan-kuda-kuda-baja-ringan"
description: "Explain reference geometry, member ID, connection checks, support, handling, and records"
status: outline
publication_date: "2026-01-29"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LGS-10
primary_intent: "Control assembly"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/jig-perakitan-kuda-kuda-baja-ringan.html"
...
# Jig dan Perakitan Kuda-Kuda: Menjaga Geometri dan Identitas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Jig dan Perakitan Kuda-Kuda: Menjaga Geometri dan Identitas”
- **Reader and situation:** Fabricator/QA
- **Reader outcome:** Explain reference geometry, member ID, connection checks, support, handling, and records
- **Primary intent:** Control assembly
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No jig/assembly design; LGS-06-03 owns method comparison
- **Final public route:** `/artikel/jig-perakitan-kuda-kuda-baja-ringan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Jig dan Perakitan Kuda-Kuda: Menjaga Geometri dan Identitas**.
...
- `LGS-10-02` → `/artikel/traceability-material-baja-ringan.html` — Traceability Material dari Coil atau Bundel ke Komponen
- `LGS-10-03` → `/artikel/kontrol-pemotongan-profil-baja-ringan.html` — Cutting, Punching, Burr, dan Kerusakan Coating
- `LGS-10-05` → `/artikel/inspeksi-dimensi-fabrikasi-baja-ringan.html` — Pemeriksaan Dimensi Komponen dan Assembly Baja Ringan
- `LGS-10-06` → `/artikel/ncr-fabrikasi-baja-ringan.html` — NCR Fabrikasi: Karantina, Evaluasi, Rework, atau Reject
...
- **Tie back to this article:** Keep the explanation specific to “Jig dan Perakitan Kuda-Kuda: Menjaga Geometri dan Identitas”.
