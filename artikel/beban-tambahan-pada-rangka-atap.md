---
article_id: LGS-09-05
title: "Panel Surya, Tangki, Ducting, dan Beban Tambahan di Atap"
slug: "beban-tambahan-pada-rangka-atap"
description: "Define load/support, access, penetration, corrosion, wind, maintenance, and approval data"
status: outline
publication_date: "2026-01-08"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LGS-09
primary_intent: "Escalate added loads"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/beban-tambahan-pada-rangka-atap.html"
...
# Panel Surya, Tangki, Ducting, dan Beban Tambahan di Atap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Panel Surya, Tangki, Ducting, dan Beban Tambahan di Atap”
- **Reader and situation:** Owner/MEP contractor
- **Reader outcome:** Define load/support, access, penetration, corrosion, wind, maintenance, and approval data
- **Primary intent:** Escalate added loads
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Retrofit design belongs to LGS-17-05
- **Final public route:** `/artikel/beban-tambahan-pada-rangka-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panel Surya, Tangki, Ducting, dan Beban Tambahan di Atap**.
...
- **Tie back to this article:** Keep the explanation specific to “Panel Surya, Tangki, Ducting, dan Beban Tambahan di Atap”.
